					  ...
					  struct platform_device *pdev)
{
	...
	/* Map the memory */
	ret = of_property_read_u32_array(pdev->dev.of_node, "qcom,wcnss-mmio", mmio, 2);
	if (ret) {
...
static int wcn36xx_probe(struct platform_device *pdev)
{
	...
	wcn->chip_version = !!of_device_get_match_data(&pdev->dev);
...
static const struct of_device_id wcn36xx_of_match[] = {
	{ .compatible = "qcom,wcn3620-wlan", (void*)WCN36XX_CHIP_3680 },
	{ .compatible = "qcom,wcn3660-wlan", (void*)WCN36XX_CHIP_3660 },
	{ .compatible = "qcom,wcn3680-wlan", (void*)WCN36XX_CHIP_3680 },
	{}
};
